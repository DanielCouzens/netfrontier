  ...
  return (
    <Layout>
      <Seo
        ...
        description="This privacy policy will explain Net Frontier uses the
          personal data we collect from you when you use our website."
      />
      <div className="privacy">
        <h1>Net Frontier Privacy Policy</h1>
        ...
        <p>Net Frontier collects the following data:</p>
        <ul>
          <li>
        ...
        <p>
          You directly provide Net Frontier with most of the data we collect. We
        ...
        {/* <p>
          Net Frontier may also receive your data indirectly from the following
          sources:
        </p>
        <ul>
        ...
        <p>Net Frontier collects your data so that we can:</p>
        <ul>
        ...
        <p>Net Frontier will not share your data.</p>
        {/* <ul>
          <li>[List organizations that will receive data]</li>
        </ul> */}
        {/* <p>
          When Net Frontier processes your order, it may send your data to, and
          also use the resulting information from, credit reference agencies to
          prevent fraudulent purchases.
        </p> */}
        {/* <h3>How do we store your data?</h3>
        <p>
          Net Frontier securely stores your data at [enter the location and
          describe security precautions taken].
        </p>
        <p>
          Net Frontier will keep your [enter type of data] for [enter time
          period]. Once this time period has expired, we will delete your data
          by [enter how you delete users’ data].
        </p> */}
        <h3>Marketing</h3>
        <p>
          Net Frontier would like to send you information about products and
          services of ours that we think you might like we will not share your
          data with other companies or orginisations.
        </p>
        ...
        <p>
          You have the right at any time to stop Net Frontier from contacting
        ...
        <p>
          Net Frontier would like to make sure you are fully aware of all of
        ...
        <p>
          ...
          request Net Frontier for copies of your personal data. We may charge
          you a small fee for this service.
        </p>
        <p>
          <strong>The right to rectification</strong> &#8211; You have the right
          to request that Net Frontier correct any information you believe is
          inaccurate. You also have the right to request Net Frontier to
          complete the information you believe is incomplete.
        </p>
        <p>
          <strong>The right to erasure</strong> – You have the right to request
          that Net Frontier erase your personal data, under certain conditions.
        </p>
        <p>
          <strong>The right to restrict processing</strong> &#8211; You have the
          right to request that Net Frontier restrict the processing of your
          personal data, under certain conditions.
        </p>
        <p>
          <strong>The right to object to processing</strong> &#8211; You have
          the right to object to Net Frontier’s processing of your personal
          data, under certain conditions.
        </p>
        <p>
          <strong>The right to data portability</strong> &#8211; You have the
          right to request that Net Frontier transfer the data that we have
        ...
        <p>
          ...
          email: info@netfrontier.co.uk.
        </p>
        <p>Call us at: 01454 616080</p>
        ...
        <p>
          Net Frontier uses cookies in a range of ways to improve your
        ...
        <ul>
          <li>
            Functionality – Net Frontier uses these cookies so that we recognize
          ...
          <li>
            Advertising – Net Frontier uses these cookies to collect information
            ...
            address. Net Frontier sometimes shares some limited aspects of this
        ...
        <p>
          The Net Frontier website contains links to other websites. Our privacy
        ...
        <p>
          Net Frontier keeps its privacy policy under regular review and places
          any updates on this web page. This privacy policy was last updated on
          9 October 2020.
        </p>
        <h3>How to contact us</h3>
        <p>
          If you have any questions about Net Frontier’s privacy policy, the
          data we hold on you, or you would like to exercise one of your data
          protection rights, please do not hesitate to contact us.
        </p>
        <p>Email us at: info@netfrontier.co.uk</p>
        <p>Call us: 01454 616080</p>
        <p>
          Or write to us at: 110 Hickory Lane, Almondsbury, Bristol, BS32 4FN
        </p>
        <h3>How to contact the appropriate authority</h3>
        <p>
          Should you wish to report a complaint or if you feel that Net Frontier
